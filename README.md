...
Published to [crates.io](https://crates.io/crates/clientapi-pbs) on
every GitHub release:

```bash
cargo add clientapi-pbs
```
...
```rust
use clientapi_pbs::apis::{configuration::Configuration, qemu_api, nodes_api};
...
```rust
use clientapi_pbs::models::PveQemuNetConfig;
