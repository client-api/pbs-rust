...
pub struct ConfigDatastoreGetDatastoreResponseDataInner {
...
impl ConfigDatastoreGetDatastoreResponseDataInner {
    pub fn new(name: String, path: String) -> ConfigDatastoreGetDatastoreResponseDataInner {
