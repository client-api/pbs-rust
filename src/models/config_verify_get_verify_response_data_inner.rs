...
pub struct ConfigVerifyGetVerifyResponseDataInner {
...
impl ConfigVerifyGetVerifyResponseDataInner {
    pub fn new(id: String, store: String) -> ConfigVerifyGetVerifyResponseDataInner {
