...
pub struct ConfigTrafficControlGetTrafficControlResponseDataInner {
...
impl ConfigTrafficControlGetTrafficControlResponseDataInner {
    pub fn new(name: String, network: Vec<String>) -> ConfigTrafficControlGetTrafficControlResponseDataInner {
