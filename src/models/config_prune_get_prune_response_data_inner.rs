...
pub struct ConfigPruneGetPruneResponseDataInner {
...
impl ConfigPruneGetPruneResponseDataInner {
    pub fn new(id: String, schedule: String, store: String) -> ConfigPruneGetPruneResponseDataInner {
