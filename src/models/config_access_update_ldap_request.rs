...
pub struct ConfigAccessUpdateLdapRequest {
    ...
    pub delete: Option<Vec<models::PbsDeleteEnum>>,
...
impl ConfigAccessUpdateLdapRequest {
    pub fn new() -> ConfigAccessUpdateLdapRequest {
