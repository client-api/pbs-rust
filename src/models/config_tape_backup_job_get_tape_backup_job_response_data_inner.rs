...
pub struct ConfigTapeBackupJobGetTapeBackupJobResponseDataInner {
...
impl ConfigTapeBackupJobGetTapeBackupJobResponseDataInner {
    pub fn new(drive: String, id: String, pool: String, store: String) -> ConfigTapeBackupJobGetTapeBackupJobResponseDataInner {
