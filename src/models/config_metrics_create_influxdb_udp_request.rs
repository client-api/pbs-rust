...
pub struct ConfigMetricsCreateInfluxdbUdpRequest {
...
impl ConfigMetricsCreateInfluxdbUdpRequest {
    pub fn new(host: String, name: String) -> ConfigMetricsCreateInfluxdbUdpRequest {
