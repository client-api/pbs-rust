...
pub struct NodesNetworkGetNetworkResponseDataInner {
    ...
    #[serde(rename = "type")]
    pub r#type: models::PbsNodesNetworkTypeEnum,
...
impl NodesNetworkGetNetworkResponseDataInner {
    pub fn new(active: bool, altnames: Vec<String>, autostart: bool, name: String, options: Vec<String>, options6: Vec<String>, r#type: models::PbsNodesNetworkTypeEnum) -> NodesNetworkGetNetworkResponseDataInner {
