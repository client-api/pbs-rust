...
pub struct ConfigNotificationsUpdateMatchersRequest {
    ...
    pub delete: Option<Vec<models::PbsConfigNotificationsInlineEnum5>>,
...
impl ConfigNotificationsUpdateMatchersRequest {
    pub fn new() -> ConfigNotificationsUpdateMatchersRequest {
