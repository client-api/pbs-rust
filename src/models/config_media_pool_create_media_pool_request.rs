...
pub struct ConfigMediaPoolCreateMediaPoolRequest {
...
impl ConfigMediaPoolCreateMediaPoolRequest {
    pub fn new(name: String) -> ConfigMediaPoolCreateMediaPoolRequest {
