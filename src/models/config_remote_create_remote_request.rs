...
pub struct ConfigRemoteCreateRemoteRequest {
...
impl ConfigRemoteCreateRemoteRequest {
    pub fn new(auth_id: String, host: String, name: String, password: String) -> ConfigRemoteCreateRemoteRequest {
